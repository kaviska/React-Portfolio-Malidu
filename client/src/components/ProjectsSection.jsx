...
const projects = [
  ...
  },
  {
    ...
    title: "POS System",
    category: "E-commerce",
    description: "Comprehensive web-based Point of Sale system with admin dashboard. Features include inventory management, sales tracking, and user authentication. Login with admin@gmail.com / Admin@123 for demo access.",
    image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&q=80&fit=crop",
    tags: ["Next", "React", "Tailwind", "MySql", "Github"],
    demoUrl: "https://pos-sample-psi.vercel.app/dashboard",
    githubUrl: "https://github.com/kaviska",
    featured: true,
